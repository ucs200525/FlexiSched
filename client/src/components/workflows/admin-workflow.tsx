        ...
        <TabsList className="grid w-full grid-cols-5">
          {stepTitles.map((title, index) => (
            <TabsTrigger 
              ...
              disabled={index + 1 > currentStep && currentStep < 5}
            >
              {title}
            </TabsTrigger>
          ))}
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <Select 
                    ...
                    onValueChange={(value: "theory" | "lab" | "both") => setNewCourse(prev => ({ ...prev, type: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  ...
                  <Select 
                    ...
                    onValueChange={(value: "core" | "elective" | "skill" | "project") => setNewCourse(prev => ({ ...prev, category: value }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  <Label htmlFor="strength">Expected Strength</Label>
                  <Input
                    id="strength"
                    type="number"
                    min="20"
                    max="200"
                    value={newCourse.expectedStrength}
                    onChange={(e) => setNewCourse(prev => ({ ...prev, expectedStrength: parseInt(e.target.value) }))}
                  />
                </div>
              </div>
              ...
              {courses.length > 0 && (
                <div className="space-y-2">
                  <Label className="text-base font-medium">Added Courses ({courses.length})</Label>
                      ...
                      <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            {course.credits} credits • {course.type} • {course.category} • {course.expectedStrength} students
                          </div>
                        </div>
                        <Button 
                          variant="outline" 
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Faculty Assignment & Availability
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Course Management */}
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <Label className="text-base font-medium">Course Management</Label>
                  <Button variant="outline" size="sm" onClick={() => setShowCourseImport(true)}>
                    ...
                    <Card key={index} className="border-l-4 border-l-blue-500">
                      <CardContent className="p-4">
                        <div className="grid grid-cols-1 lg:grid-cols-6 gap-4 items-center">
                          ...
                          <div className="text-center">
                            <div className="text-sm text-muted-foreground">Expected Strength</div>
                            <div className="font-medium">{course.expectedStrength} students</div>
                          </div>
                          <div className="text-center">
                            <div className="text-sm text-muted-foreground">Sections</div>
                            <div className="font-medium text-green-600">
                              {Math.ceil(course.expectedStrength / 60)}
                            </div>
                          </div>
                        </div>
                      </CardContent>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <Label className="text-base font-medium">Course-Faculty Assignment</Label>
                  <Badge variant="outline">
                    {faculty?.length || 0} Faculty Available
                  </Badge>
                </div>
                      ...
                      <CardContent className="p-4">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-center">
                          ...
                          <div>
                            <div className="font-medium">{course.courseCode} - {course.courseName}</div>
                            <div className="text-sm text-muted-foreground">
                              {course.credits} credits • {course.type} • {course.expectedStrength} students
                            </div>
                          </div>
                          
                          {/* Faculty Selection */}
                          <div>
                            <Label className="text-sm">Assign Faculty</Label>
                            <Select>
                              <SelectTrigger>
                          ...
                          <div className="text-right">
                            <div className="text-sm text-muted-foreground">Workload Impact</div>
              ...
              <div className="space-y-4">
                <Label className="text-base font-medium">Faculty Availability Constraints</Label>
                
                <div className="grid gap-4">
                  {faculty?.slice(0, 3).map((facultyMember: any) => (
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between mb-3">
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">
                              {facultyMember.department} • {facultyMember.designation}
                            </div>
                          </div>
                          <Badge variant="secondary">
                            Max: {facultyMember.maxWorkload || 18} credits
                          </Badge>
                        </div>
                        
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <Label className="text-sm">Preferred Free Day</Label>
                            <Select>
                              <SelectTrigger>
                          ...
                          <div>
                            <Label className="text-sm">Specialization Match</Label>
                            <div className="flex items-center gap-2 mt-2">
                              <CheckCircle className="w-4 h-4 text-green-500" />
                              <span className="text-sm">Auto-matched based on expertise</span>
                            </div>
                          </div>
                        </div>
                      </CardContent>
              ...
              <Card className="bg-muted/50">
                <CardHeader>
                  <CardTitle className="text-base">Faculty Workload Summary</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-muted-foreground">Courses to Assign</div>
                    </div>
                    <div className="text-center">
                    ...
                    <div className="text-center">
                      <div className="text-2xl font-bold text-green-600">
                        {Math.round((courses.reduce((sum, course) => sum + course.credits, 0) / ((faculty?.length || 1) * 18)) * 100)}%
                      </div>
        ...
        <TabsContent value="4">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <Label className="text-base font-medium">Room Inventory</Label>
                  <Button variant="outline" size="sm" onClick={() => setShowRoomImport(true)}>
                    <Upload className="w-4 h-4 mr-1" />
                    Import Rooms
                  </Button>
                </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <Button 
                ...
                className="w-full py-6 bg-gradient-to-r from-primary to-secondary text-white"
              >
                {isGenerating ? (
                  <>
